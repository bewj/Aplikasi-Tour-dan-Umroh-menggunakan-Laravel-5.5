...
@section('breadcrumb')
  ...
  <li>Dashboard</li>
  <li class="{{ set_active('umroh.edit') }}">Edit Paket Umroh</li>
@endsection
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          {!! Form::model($umroh,['url' => route('umroh.update',$umroh->umroh_id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
              ...
              <div class="col-md-9">
                <div class="radio">
                  <label style="margin-right: 10px;">
                    {!! Form::radio('category', 'Ekonomis', true) !!} Ekonomis
                  </label>
                  <label style="margin-right: 10px;">
                    {!! Form::radio('category', 'Gold') !!} Gold
                  </label>
                  <label style="margin-right: 10px;">
                    {!! Form::radio('category', 'VIP') !!} VIP
                  </label>
                </div>
