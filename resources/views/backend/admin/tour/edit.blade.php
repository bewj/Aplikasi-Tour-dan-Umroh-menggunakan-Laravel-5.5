...
@section('breadcrumb')
  ...
  <li>Dashboard</li>
  <li class="{{ set_active('tour.edit') }}">Edit Paket Tour</li>
@endsection
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">EDIT PAKET TOUR</h3>
        </div>
        <div class="box-body">
          {!! Form::model($tour,['url' => route('tour.update',$tour->tour_id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
          <div class="form-group {{ $errors->has('name') ? 'has-error': ' '}}">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                {!! Form::text('duration',null, ['class' => 'form-control', 'placeholder' => 'duration PERJALANAN']) !!}
