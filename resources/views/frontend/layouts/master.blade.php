...
<html lang="{{ app()->getLocale() }}" class="no-js">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/ionicons/css/ionicons.css') }}">
    ...
    <div id="home">
              ...
              <div id="top-menu-white" class="custom">
                ...
                <div id="menu-white-user">
                  ...
                  @else
                    <li>
                      @if (Auth::user()->name)
                        <a href="{{ route('dashboard.admin') }}"> {{ Auth::user()->name }}</a>
                      @endif
                    </li>
                    <li>
      ...
      <div class="slideshowImage">
        <div class="slideContainer">
          {{-- @for ($i = 1; $i < 7; $i++) --}}
            <a class="slideLink" href="{{ route('beranda') }}"><div class="slideImages" style="background-image: url({!! asset("img/CONTOH-SLIDESHOW.png") !!});"></div></a>
            <a class="slideLink"><div class="slideImages" style="background-image: url({!! asset("img/slideshow.jpg") !!});"></div></a>
            <a class="slideLink"><div class="slideImages" style="background-image: url({!! asset("img/slideshow1.png") !!});"></div></a>
            <a class="slideLink"><div class="slideImages" style="background-image: url({!! asset("img/slideshow2.jpeg") !!});"></div></a>
            <a class="slideLink"><div class="slideImages" style="background-image: url({!! asset("img/slideshow3.jpg") !!});"></div></a>
            <a class="slideLink"><div class="slideImages" style="background-image: url({!! asset("img/slideshow4.jpg") !!});"></div></a>
          {{-- @endfor --}}
        </div>
        <div class="slideBtnContainer">
        @for ($i = 1; $i < 7; $i++)
          <div id="" class="slideBtnIndex" onclick="currentDiv({{$i}})"></div>
        @endfor
        </div>
